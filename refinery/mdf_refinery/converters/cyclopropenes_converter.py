...
# This is the converter for: Heptamethyl Indenyl (Ind*) Enables Diastereoselective Benzamidation of Cyclopropenes via Rh(III)-Catalyzed C-H Activation
# Arguments:
...
def convert(input_path, metadata=None, verbose=False):
    ...
    if not metadata:
        ...
        dataset_metadata = {
            "mdf": {
                ...
                "citation": ["Paton, R., & Jackson, K. (2016). Heptamethyl Indenyl (Ind*) Enables Diastereoselective Benzamidation of Cyclopropenes via Rh(III)-Catalyzed C-H Activation [Data set]. Zenodo. http://doi.org/10.5281/zenodo.53736"],
                ...
                "collection": "Diastereoselective Benzamidation of Cyclopropenes",
                "tags": ["DFT", "Gaussian", "Transition State", "Stereoselectivity"],
                ...
                "links": {
                    ...
                    "landing_page": "https://zenodo.org/record/53736#.WWWmjMaZPFQ",
                    "publication": ["http://pubs.rsc.org/en/content/articlelanding/2016/sc/c6sc02587k#!divAbstract"],
                    #"data_doi": "",
                    #"related_id": ,
    ...
    for data_file in tqdm(find_files(input_path, ".out$"), desc="Processing files", disable=not verbose):
        record = parse_ase(os.path.join(data_file["path"], data_file["filename"]), "gaussian-out")
        ## Metadata:record
        record_metadata = {
            "mdf": {

                "title": "Diastereoselective Benzamidation of Cyclopropenes - " + record["chemical_formula"],
                "acl": ["public"],
...
#                    "related_id": ,
                    ...
                    "out": {
                        ...
                        "path": "/collections/cyclopropenes/" + data_file["filename"],
                        },
                    },
