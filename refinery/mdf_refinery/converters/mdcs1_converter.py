...
# This is the converter for the mdcs1 MDCS instance.
# Arguments:
...
#                "year": ,
                ...
                "links": {
                    ...
                    "landing_page": "https://mdcs1.nist.gov/rest/explore/select?id=" + schema_dir.split("_")[1],
...
#                    "description": ,
                    ...
                    "links": {
                        ...
                        "landing_page": "https://mdcs1.nist.gov/explore/detail_result_keyword?id=" + record["_id"],
...
#                            "globus_endpoint": ,
                            ...
                            # RCM string: The fully-qualified HTTP hostname, including protocol, but without the path (for example, 'https://data.materialsdatafacility.org')
                            "http_host": "https://mdcs1.nist.gov",
