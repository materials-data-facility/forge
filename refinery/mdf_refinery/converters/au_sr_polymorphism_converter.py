...
# This is the converter for: Polymorphism in magic-sized Au144(SR)60 clusters
# Arguments:
    ...
    if not metadata:
        ...
        dataset_metadata = {
            "mdf": {
                ...
                "acl": ["public"],
                "source_name": "au_sr_polymorphism",
                ...
                "citation": ["Juhas, P., Billinge, S., Jensen, K., Tofanelli, M., Ackerson, C., & Vaughn, G. (2016). ncomm-goldnp-2016: Release 3.0 [Data set]. Zenodo. http://doi.org/10.5281/zenodo.56682"],
                ...
                },
                {
                    ...
                    "email": "Chris.Ackerson@colostate.edu",
                    "institution": "Colorado State University",
                ...
                "collection": "Polymorphism in Au144(SR)60 Clusters",
                "tags": ["Inorganic chemistry", "Nanoparticles", "Physical chemistry", "pair distribution function", "gold cluster", "nanoparticle", "x-ray diffraction", "polymorphism"],
                ...
                "links": {
                    ...
                    "zip": {
                        ...
                        "path": "/record/56682/files/ncomm-goldnp-2016-v3.0.zip",
                        },
                    },
                },
...
#                    "related_id": ,
                    ...
                    "xyz": {
                        ...
                        "path": "/collections/au_sr_polymorphism/" + data_file["filename"],
                        },
                    },
