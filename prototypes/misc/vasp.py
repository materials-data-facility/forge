# Place in /Library/Frameworks/Python.framework/Versions/3.6/lib/python3.6/site-packages/ase/io/
"""
...
def read_vasp(filename='CONTCAR'):
    ...
    for ii in range(3):
        try:
            ...
            a.append(floatvect)
        except ValueError:  # Swallow floats running together
            pass
    ...
    for n, line in enumerate(data):
        ...
        if 'direct lattice vectors' in line:
            try:
                ...
                atoms.set_cell(cell)
            except ValueError:  # Swallow issues with floats running together
                pass
